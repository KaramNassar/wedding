<section class="py-8 bg-pink-50">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 class="text-3xl font-bold text-pink-700 sm:text-4xl">Locations</h2>
        <p class="mt-4 text-lg text-pink-600">
            Join us at these beautiful locations for our special day.
        </p>
