<footer class="w-full bg-amber-50 shadow-inner text-gray-800 py-12">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto">
            <a href="{{ route('home') }}" class="group">
                <div class="flex items-center justify-center gap-2 text-3xl font-great  text-amber-900">
            ...
            <h3 class="text-xl text-center text-amber-800 mt-4">{{ trans('common.footer.subtitle') }}</h3>
            <ul class="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-8">
                <li>
                    <a href="{{ route('home') }}"
