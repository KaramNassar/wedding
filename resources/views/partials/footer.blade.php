<footer class="w-full bg-gradient-to-r from-pink-200 via-pink-100 to-pink-200 text-gray-800 py-12">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto">
            <a href="{{ route('home') }}" class="group">
                <div class="flex items-center justify-center gap-2 text-xl font-serif text-pink-700">
                    <span class="font-bold">Hussam</span>
                    ...
                    <span class="font-bold">Dzaghig</span>
                </div>
            </a>
            <h3 class="text-xl text-center text-pink-600">Thank You for Being Part of Our Journey!</h3>
            <ul class="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 mb-10 border-b border-pink-200">
                <li>
                    <a href="{{ route('home') }}"
                       class="py-2 text-sm text-pink-800 relative group">{{ trans('common.home') }}
                        <span
                            class="absolute left-0 bottom-0 block w-0 h-0.5 bg-pink-800 transition-all duration-300 group-hover:w-full"></span>
                    </a>
                </li>
                <li>
                    <a href="#schedule" class="py-2 text-sm text-pink-800 relative group">{{ trans('common.schedule') }}
                        <span
                            class="absolute left-0 bottom-0 block w-0 h-0.5 bg-pink-800 transition-all duration-300 group-hover:w-full"></span>
                    </a>
                </li>
                <li>
                    <a href="#gallery" class="py-2 text-sm text-pink-800 relative group">{{ trans('common.gallery') }}
                        <span
                            class="absolute left-0 bottom-0 block w-0 h-0.5 bg-pink-800 transition-all duration-300 group-hover:w-full"></span>
                    </a>
                </li>
                <li>
                    <a href="#our-story"
                       class="py-2 text-sm text-pink-800 relative group">{{ trans('common.our story') }}
                        <span
                            class="absolute left-0 bottom-0 block w-0 h-0.5 bg-pink-800 transition-all duration-300 group-hover:w-full"></span>
                    </a>
                </li>
                <li>
                    <a href="#faqs" class="py-2 text-sm text-pink-800 relative group">{{ trans('common.faqs') }}
                        <span
                            class="absolute left-0 bottom-0 block w-0 h-0.5 bg-pink-800 transition-all duration-300 group-hover:w-full"></span>
                    </a>
                </li>
                <li>
                    <a href="#rsvp" class="py-2 text-sm text-pink-800 relative group">{{ trans('common.rsvp') }}
                        <span
                            class="absolute left-0 bottom-0 block w-0 h-0.5 bg-pink-800 transition-all duration-300 group-hover:w-full"></span>
                    </a>
                </li>
            ...
            <div class="flex space-x-10 justify-center items-center mb-14">
                <a href="#" class="block  text-gray-900 transition-all duration-500 hover:text-pink-600 ">
