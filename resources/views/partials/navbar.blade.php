<ul class="bg-amber-50 max-lg:fixed max-lg:top-0 max-lg:left-0 rtl:max-lg:right-0 z-50 max-lg:h-full max-lg:w-1/4 max-lg:overflow-auto lg:bg-none max-lg:p-4 max-lg:shadow-md max-lg:space-y-3 max-lg:min-w-[300px] lg:flex lg:gap-x-8  transition-all duration-500 ease-in-out">
    <li>
